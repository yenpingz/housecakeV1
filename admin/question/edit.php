   ...
   require_once("../../connection/database.php");
    if(isset($_POST['MM_update']) && $_POST['MM_update'] == "UPDATE"){
      $sql= "UPDATE question SET
                title = :title,
                content = :content,
                updatedDate = :updatedDate WHERE questionID=:questionID";
      $sth = $db ->prepare($sql);
      ...
      header("Location: list.php?questioncategoryID=".$_POST['questioncategoryID']);
    }
    $sth = $db->query("SELECT * FROM question WHERE questionID=".$_GET['questionID']);
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" data-toggle="validator" action="edit.php" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="updatedDate" name="updatedDate" value="<?php echo $question['publishedDate']; ?>" required>
              ...
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="title" class="control-label">購物問題</label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" name="title" value="<?php echo $question['title']; ?>" data-error="請輸入標題" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="content" data-minlength="6" name="content"><?php echo $question['content']; ?></textarea>
                  <div class="help-block">最少輸入6字元</div>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-10 col-sm-offset-2 text-right">
                  <input type="hidden" name="questioncategoryID" value="<?php echo $question['questioncategoryID'] ?>">
